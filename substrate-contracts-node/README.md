...
> ⚠️ This is a dirty patched version of [substrate-contracts-node](https://github.com/paritytech/substrate-contracts-node).
>
> Provides block finalization of instant sealed blocks until there is support in the official development node.
>
> Will be removed as soon as it happens.
